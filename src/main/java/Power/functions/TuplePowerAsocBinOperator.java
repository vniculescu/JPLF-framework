...
/**
 * The Class TuplePowerAsocBinOperator.
 *
 ...
 */
public class TuplePowerAsocBinOperator<T extends FieldElement<T>> extends TuplePowerResultFunction<T> {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 92260967896958645L;
	...
	/**
	 * Instantiates a new tuple power asoc bin operator.
	 *
	 ...
	 */
	public TuplePowerAsocBinOperator(List<BiFunction<T, T, T>> operator, IPowerList<T> arg1, IPowerList<T> arg2,
...
//Factory methods
	...
	public TuplePowerResultFunction<T> create_left_function() {
		TuplePowerAsocBinOperator<T> fleft = new TuplePowerAsocBinOperator<T>(this.operator, left_power_arg.get(0),
	...
	public TuplePowerResultFunction<T> create_right_function() {
		TuplePowerAsocBinOperator<T> fright = new TuplePowerAsocBinOperator<T>(this.operator, right_power_arg.get(0),
