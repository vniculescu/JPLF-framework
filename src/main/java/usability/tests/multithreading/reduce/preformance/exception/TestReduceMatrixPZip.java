...
public class TestReduceMatrixPZip {
	public static void main(String[] args) throws IOException {
		...
		ZipPList<Matrix> list = pFactory.toZipPList(matrixList);
		...
		ParesUtils.log(TestReduceMatrixPZip.class.getSimpleName() + Integer.toString(limit),
